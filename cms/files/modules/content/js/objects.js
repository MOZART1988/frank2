...
function oObjects(div){
    ...
    this.viewList = function(){
        return this.load(
            function(list){
                that.div.html('<div><a style="float: left;" href="#createObject" onclick="return UI.command(\'#createObject\')">+Создать объект</a> &nbsp;&nbsp; <span class="moveanddeletespan" style="float: left; margin-left: 286px;"><a href="#deleteObjects"" onclick="return UI.command(\'#deleteObjects\')">Удалить</a></span></div><div style="clear: both;">    <div id="mask" style="display:none;position:fixed;top:0;left:0;right:0;bottom:0;background:#eee;z-index:9999"></div><div id="formholder" style="position:absolute;top:0;left:0;z-index:99999"></div>    </div>');
